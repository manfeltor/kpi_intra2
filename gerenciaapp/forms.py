...
class DateRangeForm(forms.Form):
    start_date = forms.DateField(label='from_date_management', widget=forms.DateInput(attrs={'type': 'date'}))
    end_date = forms.DateField(label='until_date_management', widget=forms.DateInput(attrs={'type': 'date'}))
